document.addEventListener('DOMContentLoaded', () => {
  ...
  // Casas de aposta que você quer mostrar
  ...
  async function buscarOdds() {
    ...
    try {
      ...
      dados.forEach(jogo => {
        ...
        // Para cada casa de aposta permitida, cria uma linha da tabela
        jogo.odds.forEach(bk => {
          if (!casasPermitidas.includes(bk.casa)) return;
          ...
          // Colunas extras vazias (se precisar, pode preencher depois)
